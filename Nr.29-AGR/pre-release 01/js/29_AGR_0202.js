            ...
            if (row_45_031_CAP2(i)) {
                ...
                if (col1 == 0 &&  col2 != 0 ) {
                    webform.errors.push({
                        'fieldName': 'CAP1_R' + (i) + '_C3',
                        'weight': 32,
                        'msg': Drupal.t('Cod eroare: 45-045 [@col1]  - Daca COL3 > 0 atunci COL4 > 0  - [@col2]', { "@col1": col1, "@col2": col2 })
                    });
                }
    ...
    for (var i = 1; i <= 2; i++) {
        ...
        if (R1116_C != R1117_C) {
            webform.errors.push({
                ...
                'weight': 37,
                'msg': Drupal.t('Cod eroare: 45-037. [@R1116_C] - Rind.1116  = Rind.1117 pe coloana. @col  -  [@R1117_C]', { '@col': i, '@R1116_C': R1116_C, '@R1117_C': R1117_C })
            });
        }
    }
