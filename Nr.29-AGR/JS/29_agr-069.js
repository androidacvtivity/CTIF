        ...
        for (var i = 3; i < 8; i++) {
            {
                ...
                if (col1 < col2) {
                    webform.errors.push({
                        ...
                        'weight': 12,
                        'msg': Drupal.t('Cod eroare: 45-003 Rind.(1103-1238,1240,1302-1327,1401-1409,2101-2412) COL1 >= Rind.(1103-1238,1240,1302-1327,1401-1409,2101-2412) COL2 ')
                    });
                }
            }
        }
        ...
        for (var i = 1; i <= 5; i++) {
            {
                ...
                var col1 = Number(values["CAP2_R23" + (i <= 5 ? ('0' + i) : i) + "_C1"]);
                var col2 = Number(values["CAP2_R23" + (i <= 5 ? ('0' + i) : i) + "_C2"]);

                if (col1 < col2) {
                    webform.errors.push({
                        'fieldName': 'CAP2_R23' + (i <= 5 ? ('0' + i) : i) + '_C1',
                        'weight': 12,
                        'msg': Drupal.t('Cod eroare: 45-003 Rind.(1103-1238,1240,1302-1327,1401-1409,2101-2412) COL1 >= Rind.(1103-1238,1240,1302-1327,1401-1409,2101-2412) COL2 ')
                    });
                }
